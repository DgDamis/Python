...
Revision ID: 4eb075bdbab3
Revises: None
Create Date: 2018-10-16 13:30:25.419379

"""

# revision identifiers, used by Alembic.
revision = '4eb075bdbab3'
down_revision = None
...
def upgrade():
    ...
    op.create_table('deti',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('jmeno', sa.String(length=64), nullable=False),
    sa.Column('prijmeni', sa.String(length=64), nullable=False),
    sa.Column('datumNarozeni', sa.Date(), nullable=True),
    sa.PrimaryKeyConstraint('id', name='pk_deti'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_deti_prijmeni', 'deti', ['prijmeni'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_deti_prijmeni', table_name='deti')
    op.drop_table('deti')
