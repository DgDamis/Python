...
Revision ID: 55b05fbf40f2
Revises: None
Create Date: 2018-10-02 13:44:03.228032

"""

# revision identifiers, used by Alembic.
revision = '55b05fbf40f2'
down_revision = None
...
def upgrade():
    ...
    sa.Column('datumprvnihopristupu', sa.Date(), nullable=True),
    ...
    sa.Column('cast', sa.Integer(), nullable=False),
    sa.Column('cena', sa.Float(), nullable=True),
    sa.PrimaryKeyConstraint('id', name='pk_vyrobky'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_vyrobky_cast', 'vyrobky', ['cast'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_vyrobky_cast', table_name='vyrobky')
