...
Revision ID: 345caa33dbc6
Revises: None
Create Date: 2019-04-09 12:57:41.083144

"""

# revision identifiers, used by Alembic.
revision = '345caa33dbc6'
down_revision = None
...
def upgrade():
    ...
    op.create_index('ix_data_hodnota', 'data', ['hodnota'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_data_hodnota', table_name='data')
    op.drop_table('data')
